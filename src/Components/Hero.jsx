...
const Hero = () => {
  ...
  return (
    <Box sx={{ backgroundColor: "#f0eff0b7", minHeight: "80vh" }}>
      <Container>
        <Navbar />
        <CustomBox>
          <Box sx={{ flex: "1" }}>
            <Typography variant="body2" sx={{ fontSize: "18px", color: "#687690", fontWeight: "500", mt: 10, mb: 4 }}>
              Welcome to Real Deal Properties
            </Typography>
            <Title variant="h1">
              Discover a place where you will love to live
            </Title>
            <Typography variant="body2" sx={{ fontSize: "18px", color: "#5A6473", my: 4 }}>
              Be the first to get the best real estate deals before they hit the mass market! Not foreclosure deals with one simle search.
            </Typography>
